...
(3, '1000', '10', '50', 'GA', 'IN', 'Patna Camp', 'Patna NaN', NULL, 0, 'admin', '2023-01-18 18:48:18', '2023-01-18 18:48:18', NULL),
(4, '1000', '20', '30', 'AP', 'SG', 'test', 'hh', NULL, 0, 'admin', '2023-02-14 19:50:22', '2023-02-14 19:50:22', NULL),
...
(18, '1000', '2022', '2022-04-01 00:00:00', '2023-03-31 00:00:00', 0, 1, '2022-03-01 00:00:00', '2022-03-31 00:00:00', 0, 'admin', '2021-11-13 12:49:22', '2023-05-02 08:18:51', NULL),
...
CREATE TABLE `t05903l03` (
  `id` bigint(20) NOT NULL,
  `weekday` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
INSERT INTO `t05903l03` (`id`, `weekday`, `FYWOHCalendarId`, `FYWOHFiscalYearId`, `FYWOHDesc1`, `FYWOHDesc2`, `FYWOHSunday`, `FYWOHMonday`, `FYWOHTuesday`, `FYWOHWednesday`, `FYWOHThursday`, `FYWOHFriday`, `FYWOHSaturday`, `FYWOHTotalWeeklyOff`, `FYWOHBiDesc`, `FYWOHMarkForDeletion`, `FYWOHUser`, `FYWOHLastCreated`, `FYWOHLastUpdated`, `FYWOHDeletedAt`) VALUES
(1, '{\"sunday\":{\"all\":\"all\"},\"tuesday\":{\"second\":\"1\"},\"saturday\":{\"fourth\":\"1\"}}', '1000', '2022', NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, 0, 'admin', '2023-05-18 19:50:56', '2023-05-18 19:50:56', NULL);
...
--
-- Table structure for table `t05903l0312`
--

CREATE TABLE `t05903l0312` (
  `id` bigint(20) NOT NULL,
  `FYWOMDayId` tinyint(4) NOT NULL,
  `FYWOMDesc1` varchar(30) NOT NULL,
  `FYWOMAll` tinyint(4) NOT NULL,
  `FYWOMFirst` tinyint(4) NOT NULL,
  `FYWOMSecond` tinyint(4) NOT NULL,
  `FYWOMThird` tinyint(4) NOT NULL,
  `FYWOMFourth` tinyint(4) NOT NULL,
  `FYWOMFifth` tinyint(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, '1000', '2022', 0, 'admin', '2023-05-27 08:04:59', '2023-05-29 11:07:07', NULL),
(5, '1100', '2023', 0, 'admin', '2023-05-29 12:13:07', '2023-05-29 12:13:07', NULL),
(6, '1000', '2023', 0, 'admin', '2023-05-30 09:57:04', '2023-05-30 09:57:04', NULL);
...
(1, 1, '1000', '2022', 'PH', '2023-05-01 00:00:00', 'L day', NULL, NULL, 0, '3SIS', '2023-05-27 08:04:59', '2023-05-27 08:04:59', NULL),
(2, 1, '1000', '2022', 'PH', '2023-05-08 00:00:00', 'B Day', NULL, NULL, 0, '3SIS', '2023-05-27 08:04:59', '2023-05-27 08:04:59', NULL),
(3, 5, '1100', '2023', 'PH', '2023-05-01 00:00:00', 'jjj', NULL, NULL, 0, '3SIS', '2023-05-29 12:13:07', '2023-05-29 12:13:07', NULL),
(4, 6, '1000', '2023', 'PH', '2023-05-01 00:00:00', 'off', NULL, NULL, 0, '3SIS', '2023-05-30 09:57:04', '2023-05-30 09:57:04', NULL);
...
--
-- Table structure for table `t11125l03`
--
-- Error reading structure for table ems.t11125l03: #1932 - Table 'ems.t11125l03' doesn't exist in engine
-- Error reading data for table ems.t11125l03: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `ems`.`t11125l03`' at line 1

-- --------------------------------------------------------

--
-- Table structure for table `t11125l0311`
--

CREATE TABLE `t11125l0311` (
  `id` bigint(20) NOT NULL,
  `PGDADCompanyId` varchar(10) NOT NULL,
  `PGDADFiscalYear` varchar(4) NOT NULL,
  `PGDADPeriodId` bigint(2) NOT NULL,
  `PGDADLocationId` varchar(10) NOT NULL,
  `PGDADEmployeeId` varchar(10) NOT NULL,
  `PGDADIncDedId` varchar(10) NOT NULL,
  `PGDADDesc1` varchar(100) NOT NULL,
  `PGDADGrossDeduction` decimal(16,2) NOT NULL DEFAULT 0.00,
  `PGDADNetDeduction` decimal(16,2) NOT NULL DEFAULT 0.00,
  `PGDADFromDate` datetime NOT NULL DEFAULT current_timestamp(),
  `PGDADToDate` datetime NOT NULL DEFAULT current_timestamp(),
  `PGDADStatusId` int(11) NOT NULL,
  `PGDADMarkForDeletion` tinyint(1) NOT NULL,
  `PGDADUser` varchar(50) NOT NULL DEFAULT '3SIS',
  `PGDADLastCreated` datetime NOT NULL DEFAULT current_timestamp(),
  `PGDADLastUpdated` datetime NOT NULL DEFAULT current_timestamp(),
  `PGDADDeletedAt` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `t11125l0311`
--

INSERT INTO `t11125l0311` (`id`, `PGDADCompanyId`, `PGDADFiscalYear`, `PGDADPeriodId`, `PGDADLocationId`, `PGDADEmployeeId`, `PGDADIncDedId`, `PGDADDesc1`, `PGDADGrossDeduction`, `PGDADNetDeduction`, `PGDADFromDate`, `PGDADToDate`, `PGDADStatusId`, `PGDADMarkForDeletion`, `PGDADUser`, `PGDADLastCreated`, `PGDADLastUpdated`, `PGDADDeletedAt`) VALUES
(1, '1000', '', 0, '20', '1100', '1100', 'Other Deductions', '0.00', '1000.00', '2022-03-01 00:00:00', '2022-03-31 00:00:00', 9999, 1, '3SIS', '2022-06-06 08:12:27', '2022-06-06 08:12:27', '2022-06-06 08:12:29'),
(2, '1000', '', 0, '20', '1100', '1100', 'Other Deductions', '0.00', '1000.00', '2022-03-01 00:00:00', '2022-03-31 00:00:00', 9999, 1, '3SIS', '2022-06-06 08:12:29', '2022-06-06 08:12:29', '2022-06-06 08:12:38'),
(3, '1000', '', 0, '20', '1100', '1100', 'Other Deductions', '0.00', '1000.00', '2022-03-01 00:00:00', '2022-03-31 00:00:00', 9999, 1, '3SIS', '2022-06-06 08:12:38', '2022-06-06 08:12:38', '2022-06-06 08:22:42'),
(4, '1000', '', 0, '20', '1100', '1100', 'Other Deductions', '0.00', '1000.00', '2022-03-01 00:00:00', '2022-03-31 00:00:00', 9999, 1, '3SIS', '2022-06-06 08:22:42', '2022-06-06 08:22:42', '2022-06-06 08:23:24'),
(5, '1000', '', 0, '20', '1100', '1100', 'Other Deductions', '0.00', '1000.00', '2022-03-01 00:00:00', '2022-03-31 00:00:00', 9999, 1, '3SIS', '2022-06-06 08:23:24', '2022-06-06 08:23:24', '2022-06-06 08:25:59'),
(6, '1000', '', 0, '20', '1100', '1100', 'Other Deductions', '0.00', '1000.00', '2022-03-01 00:00:00', '2022-03-31 00:00:00', 9999, 1, '3SIS', '2022-06-06 08:25:59', '2022-06-06 08:25:59', '2022-06-06 08:26:33'),
(7, '1000', '', 0, '20', '1100', '1100', 'Other Deductions', '0.00', '1000.00', '2022-03-01 00:00:00', '2022-03-31 00:00:00', 1000, 0, '3SIS', '2022-06-06 08:26:33', '2022-06-06 08:26:33', '2022-06-06 08:26:33');

-- --------------------------------------------------------

--
-- Table structure for table `t11125l0411`
--

CREATE TABLE `t11125l0411` (
  `id` bigint(20) NOT NULL,
  `PGAIDCompanyId` varchar(10) NOT NULL,
  `PGAIDFiscalYear` varchar(4) NOT NULL,
  `PGAIDPeriodId` bigint(2) NOT NULL,
  `PGAIDLocationId` varchar(10) NOT NULL,
  `PGAIDEmployeeId` varchar(10) NOT NULL,
  `PGAIDIncDedId` varchar(10) NOT NULL,
  `PGAIDDesc1` varchar(100) DEFAULT NULL,
  `PGAIDGrossAmount` decimal(16,2) NOT NULL DEFAULT 0.00,
  `PGAIDGrossPayment` decimal(16,2) NOT NULL DEFAULT 0.00,
  `PGAIDStatusId` int(11) DEFAULT NULL,
  `PGAIDMarkForDeletion` tinyint(1) NOT NULL,
  `PGAIDUser` varchar(50) NOT NULL DEFAULT '3SIS',
  `PGAIDLastCreated` datetime NOT NULL DEFAULT current_timestamp(),
  `PGAIDLastUpdated` datetime NOT NULL DEFAULT current_timestamp(),
  `PGAIDDeletedAt` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `t11125l0411`
--

INSERT INTO `t11125l0411` (`id`, `PGAIDCompanyId`, `PGAIDFiscalYear`, `PGAIDPeriodId`, `PGAIDLocationId`, `PGAIDEmployeeId`, `PGAIDIncDedId`, `PGAIDDesc1`, `PGAIDGrossAmount`, `PGAIDGrossPayment`, `PGAIDStatusId`, `PGAIDMarkForDeletion`, `PGAIDUser`, `PGAIDLastCreated`, `PGAIDLastUpdated`, `PGAIDDeletedAt`) VALUES
(1, '1000', '2023', 3, '10', '1000', '1000', NULL, '200.00', '200.00', NULL, 0, 'admin', '2023-07-04 09:20:28', '2023-07-04 09:20:28', '2023-07-04 09:20:28'),
(2, '1000', '2023', 3, '10', '1000', '1300', NULL, '500.00', '500.00', NULL, 0, 'admin', '2023-07-04 09:20:28', '2023-07-04 09:20:28', '2023-07-04 09:20:28'),
(3, '1000', '2023', 3, '20', '1200', '1000', NULL, '500.00', '100.00', NULL, 0, 'admin', '2023-07-04 09:27:47', '2023-07-04 09:27:47', '2023-07-04 09:27:47'),
(4, '1000', '2023', 3, '20', '1200', '1400', NULL, '2500.00', '2500.00', NULL, 0, 'admin', '2023-07-04 09:27:47', '2023-07-04 09:27:47', '2023-07-04 09:27:47'),
(5, '1000', '2023', 3, '20', '', '1300', NULL, '2500.00', '255.00', NULL, 0, 'admin', '2023-07-04 09:33:11', '2023-07-04 09:33:11', '2023-07-04 09:33:11');

-- --------------------------------------------------------

--
-- Table structure for table `t11130l01`
--

CREATE TABLE `t11130l01` (
  `id` bigint(20) NOT NULL,
  `LALBHLoanId` int(11) NOT NULL,
  `LALBHCompanyId` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `LALBHLocationId` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `LALBHEmployeeId` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `LALBHDeductionId` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `LALBHLoanAmount` decimal(16,2) DEFAULT 0.00,
  `LALBHInterestAmount` decimal(16,2) DEFAULT 0.00,
  `LALBHRecoveryAmount` decimal(16,2) DEFAULT 0.00,
  `LALBHNoOfEMI` int(11) DEFAULT 0,
  `LALBHEMIAmount` decimal(16,2) DEFAULT 0.00,
  `LALBHTotalDeduction` decimal(16,2) DEFAULT 0.00,
  `LALBHStartDateEMI` date DEFAULT NULL,
  `LALBHEndDateEMI` date DEFAULT NULL,
  `LALBHPaidEMI` int(11) DEFAULT 0,
  `LALBHBalanceEMI` int(11) DEFAULT 0,
  `LALBHPaidAmount` decimal(16,2) DEFAULT 0.00,
  `LALBHBalanceAmount` decimal(16,2) DEFAULT 0.00,
  `LALBHLoanPaidFully` tinyint(1) DEFAULT 0,
  `LALBHMarkForDeletion` tinyint(1) NOT NULL DEFAULT 0,
  `LALBHUser` varchar(50) CHARACTER SET utf8mb4 NOT NULL DEFAULT '3SIS',
  `LALBHStatusId` int(11) DEFAULT 9999,
  `LALBHLastCreated` datetime NOT NULL DEFAULT current_timestamp(),
  `LALBHLastUpdated` datetime NOT NULL DEFAULT current_timestamp(),
  `LALBHDeletedAt` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `t11130l01`
--

INSERT INTO `t11130l01` (`id`, `LALBHLoanId`, `LALBHCompanyId`, `LALBHLocationId`, `LALBHEmployeeId`, `LALBHDeductionId`, `LALBHLoanAmount`, `LALBHInterestAmount`, `LALBHRecoveryAmount`, `LALBHNoOfEMI`, `LALBHEMIAmount`, `LALBHTotalDeduction`, `LALBHStartDateEMI`, `LALBHEndDateEMI`, `LALBHPaidEMI`, `LALBHBalanceEMI`, `LALBHPaidAmount`, `LALBHBalanceAmount`, `LALBHLoanPaidFully`, `LALBHMarkForDeletion`, `LALBHUser`, `LALBHStatusId`, `LALBHLastCreated`, `LALBHLastUpdated`, `LALBHDeletedAt`) VALUES
(10, 1686799441, '1000', '20', '1100', '1000', '2500.00', '0.00', '25000.00', 2, '1250.00', NULL, '2023-06-01', '2023-07-31', 0, 0, '0.00', '0.00', NULL, 0, 'admin', 9999, '2023-06-21 16:20:07', '2023-06-21 16:20:07', NULL),
(11, 1687346202, '1000', '20', '1200', '1000', '2000.00', '0.00', '2000.00', 2, '1000.00', NULL, '2023-06-01', '2023-07-31', 0, 0, '0.00', '0.00', NULL, 0, 'admin', 9999, '2023-06-21 17:01:06', '2023-06-21 17:01:06', NULL),
(12, 1687349337, '1000', '10', '1300', '1300', '5000.00', '50.00', '5050.00', 2, '2525.00', NULL, '2023-06-01', '2023-07-31', 0, 0, '0.00', '0.00', NULL, 0, 'admin', 9999, '2023-06-21 17:38:58', '2023-06-21 17:38:58', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `t11130l0111`
--

CREATE TABLE `t11130l0111` (
  `id` bigint(20) NOT NULL,
  `idH` bigint(20) NOT NULL,
  `LALBDLoanId` int(11) NOT NULL,
  `LALBDCompanyId` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `LALBDLocationId` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `LALBDEmployeeId` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `LALBDDeductionId` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `LALBDEMIAmount` decimal(16,2) DEFAULT 0.00,
  `LALBDPaidAmount` decimal(16,2) DEFAULT 0.00,
  `LALBDBalanceAmount` decimal(16,2) DEFAULT 0.00,
  `LALBDEMIDate` date DEFAULT NULL,
  `LALBDMarkForDeletion` tinyint(1) NOT NULL DEFAULT 0,
  `LALBDUser` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '3SIS',
  `LALBDStatusId` int(11) DEFAULT 9999,
  `LALBDLastCreated` datetime NOT NULL DEFAULT current_timestamp(),
  `LALBDLastUpdated` datetime NOT NULL DEFAULT current_timestamp(),
  `LALBDDeletedAt` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `t11130l0111`
--

INSERT INTO `t11130l0111` (`id`, `idH`, `LALBDLoanId`, `LALBDCompanyId`, `LALBDLocationId`, `LALBDEmployeeId`, `LALBDDeductionId`, `LALBDEMIAmount`, `LALBDPaidAmount`, `LALBDBalanceAmount`, `LALBDEMIDate`, `LALBDMarkForDeletion`, `LALBDUser`, `LALBDStatusId`, `LALBDLastCreated`, `LALBDLastUpdated`, `LALBDDeletedAt`) VALUES
(17, 10, 1686799441, '1000', '20', '1100', '1000', '1250.00', NULL, '0.00', '2023-06-01', 0, '3SIS', 9999, '2023-06-15 08:54:01', '2023-06-15 08:54:01', NULL),
(18, 10, 1686799441, '1000', '20', '1100', '1000', '1250.00', NULL, '0.00', '2023-07-01', 0, '3SIS', 9999, '2023-06-15 08:58:11', '2023-06-15 08:58:11', NULL),
(19, 11, 1687346202, '1000', '20', '1200', '1000', '1000.00', NULL, '0.00', '2023-06-01', 0, '3SIS', 9999, '2023-06-21 16:46:43', '2023-06-21 16:46:43', NULL),
(21, 12, 1687349337, '1000', '10', '1300', '1300', '2525.00', NULL, '0.00', '2023-06-01', 0, '3SIS', 9999, '2023-06-21 17:38:58', '2023-06-21 17:38:58', NULL);
...
CREATE TABLE `t11906l01` (
  ...
  `PMITHPeriodId` varchar(40) DEFAULT NULL,
...
(1, '1000', 'I1000', 'Basic', 'Basic', 1, 'I5000', '0.00', '0.00', 'P', '1', 1, '1000', 10000, 0, 'admin', '2021-12-08 06:40:02', '2023-04-18 09:02:37', NULL),
(2, '1100', 'I1100', 'DA', 'DA', 1, 'Z1000', '0.00', '0.00', 'M', '', 2, '1000', 13000, 0, '3SIS', '2021-12-08 06:41:38', '2021-12-08 06:41:38', NULL),
(3, '4000', 'I4000', 'HRA', 'HRA', 1, 'I5000', '10.00', '0.00', 'M', NULL, 3, '1000', 11000, 0, 'admin', '2021-12-08 06:45:43', '2023-04-18 09:04:49', NULL),
...
(13, '1010', 'I1010', 'Test', NULL, NULL, 'I5000', '0.00', '0.00', 'M', NULL, 0, '1000', NULL, 0, 'admin', '2023-04-23 20:42:05', '2023-04-23 20:42:05', NULL);
...
CREATE TABLE `t11906l010211` (
  ...
  `PMIDDPeriodId` varchar(100) NOT NULL DEFAULT '12',
...
(20, '4000', 'I4000', 'I', 'HRA', '1,12', 0, 'admin', '2023-04-15 08:35:24', '2023-04-15 08:35:24', NULL);
...
CREATE TABLE `t11906l02` (
  ...
  `PMDTHIncDependentDed` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
INSERT INTO `t11906l02` (`id`, `PMDTHDeductionId`, `PMDTHDeductionIdK`, `PMDTHDesc1`, `PMDTHDesc2`, `PMDTHApplicableFor`, `PMDTHIsTaxExempted`, `PMDTHIsThisLoanLine`, `PMDTHShowInTaxList`, `PMDTHIsIncomeDependent`, `PMDTHIncDependentDed`, `PMDTHDedStrategy`, `PMDTHDedStrategyDesc`, `PMDTHDeductionCycle`, `PMDTHPeriodId`, `PMDTHDedPercent`, `PMDTHRuleId`, `PMDTHPrintingSeq`, `PMDTHRoundingStrategy`, `PMDTHBiElementId`, `PMDTHMarkForDeletion`, `PMDTHUser`, `PMDTHLastCreated`, `PMDTHLastUpdated`, `PMDTHDeletedAt`) VALUES
(8, '1000', 'D1000', 'Loan', 'Loan', 'C', 0, 1, 0, 0, NULL, 'C', 'Cumulative', 'M', '', '0.00', 'Z1000', 1, '1000', 24000, 0, '3SIS', '2021-12-27 15:12:39', '2022-02-15 10:11:09', NULL),
(9, '1100', 'D1100', 'Other Deductions', NULL, 'C', 0, 0, 0, 0, NULL, 'C', 'Cumulative', 'M', '', '0.00', 'Z1000', 2, '1000', 25000, 0, '3SIS', '2021-12-27 15:13:28', '2021-12-27 15:13:28', NULL),
(10, '1200', 'D1200', 'PF', 'PF', 'C', 1, 0, 0, 1, NULL, 'C', 'Cumulative', 'M', '', '0.00', 'D1000', 3, '1000', 19000, 0, 'admin', '2021-12-27 15:14:27', '2023-04-06 10:50:52', NULL),
(11, '1300', 'D1300', 'PT', 'PT', 'C', 1, 1, 1, 1, NULL, 'C', NULL, 'P', '', '0.00', 'D2000', 4, '1000', 20000, 0, 'admin', '2021-12-27 15:15:34', '2023-04-06 11:48:10', NULL),
(12, '1400', 'D1400', 'ESIC', 'ESIC', 'C', NULL, NULL, NULL, 1, '{\"id\":[\"12\",\"12\",\"12\",\"12\",\"12\"],\"PMITHIncomeId\":[\"1000\",\"1100\",\"4000\",\"1300\",\"1400\"],\"PMITHDesc1\":[\"Basic\",\"DA\",\"HRA\",\"Others\",\"CCA\"],\"check_id\":{\"0\":\"1\",\"4\":\"1\"}}', 'C', NULL, 'P', '1,12', '0.00', 'D3000', 5, '1000', 21000, 0, 'admin', '2021-12-27 15:16:51', '2023-04-23 20:30:21', NULL),
(14, '6000', 'D6000', 'WWCW', 'WED', 'C', NULL, 0, 0, 0, NULL, 'C', 'Cumulative', 'P', '', '0.00', 'D4000', 33, '1100', 1000, 1, 'admin', '2023-04-06 07:56:54', '2023-04-06 07:56:54', NULL);
...
(168, '{\"message\":\"SQLSTATE[01000]: Warning: 1265 Data truncated for column \'PMIDDPeriodId\' at row 1 (SQL: insert into `t11906l010211` (`PMIDDIncDedId`, `PMIDDIncDedIdK`, `PMIDDIncOrDed`, `PMIDDDesc`, `PMIDDPeriodId`, `PMIDDMarkForDeletion`, `PMIDDUser`, `PMIDDLastCreated`, `PMIDDLastUpdated`) values (4000, I4000, I, HRA, 1,9,12, 0, admin, 2023-04-15 08:27:18, 2023-04-15 08:27:18))\",\"line\":760,\"code\":\"01000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-04-15 08:27:18', NULL),
(169, '{\"message\":\"SQLSTATE[01000]: Warning: 1265 Data truncated for column \'PMIDDPeriodId\' at row 1 (SQL: insert into `t11906l010211` (`PMIDDIncDedId`, `PMIDDIncDedIdK`, `PMIDDIncOrDed`, `PMIDDDesc`, `PMIDDPeriodId`, `PMIDDMarkForDeletion`, `PMIDDUser`, `PMIDDLastCreated`, `PMIDDLastUpdated`) values (4000, I4000, I, HRA, 1,9,12, 0, admin, 2023-04-15 08:27:36, 2023-04-15 08:27:36))\",\"line\":760,\"code\":\"01000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-04-15 08:27:36', NULL),
(170, '{\"message\":\"SQLSTATE[01000]: Warning: 1265 Data truncated for column \'PMIDDPeriodId\' at row 1 (SQL: insert into `t11906l010211` (`PMIDDIncDedId`, `PMIDDIncDedIdK`, `PMIDDIncOrDed`, `PMIDDDesc`, `PMIDDPeriodId`, `PMIDDMarkForDeletion`, `PMIDDUser`, `PMIDDLastCreated`, `PMIDDLastUpdated`) values (4000, I4000, I, HRA, 1,9,12, 0, admin, 2023-04-15 08:29:38, 2023-04-15 08:29:38))\",\"line\":760,\"code\":\"01000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-04-15 08:29:38', NULL),
(171, '{\"message\":\"SQLSTATE[HY000]: General error: 1364 Field \'FYPHDCalendarId\' doesn\'t have a default value (SQL: insert into `t05903l0411` (`idH`, `FYPHDHolidayType`, `FYPHDHolidayDate`, `FYPHDDesc1`) values (6, P, 2023-05-15, test))\",\"line\":760,\"code\":\"HY000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-25 10:42:55', NULL),
(172, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry \'1100-2023\' for key \'FYPHDCalendarId\' (SQL: insert into `t05903l04` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `FYPHHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (1100, 2023, 2023-05-25 10:43:06, 0, admin, 2023-05-25 10:43:06))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-25 10:43:06', NULL),
(173, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1048 Column \'FYPHHCalendarId\' cannot be null (SQL: insert into `t05903l04` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `FYPHHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (?, ?, 2023-05-25 10:58:08, 0, admin, 2023-05-25 10:58:08))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-25 10:58:08', NULL),
(174, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1048 Column \'FYPHHCalendarId\' cannot be null (SQL: insert into `t05903l04` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `FYPHHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (?, ?, 2023-05-25 10:58:27, 0, admin, 2023-05-25 10:58:27))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-25 10:58:27', NULL);
INSERT INTO `technical_error` (`id`, `error`, `created_at`, `updated_at`) VALUES
(175, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry \'1000-2022\' for key \'FYPHDCalendarId\' (SQL: insert into `t05903l04` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `FYPHHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (1000, 2022, 2023-05-27 08:05:41, 0, admin, 2023-05-27 08:05:41))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-27 08:05:42', NULL),
(176, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry \'1000-2022\' for key \'FYPHDCalendarId\' (SQL: insert into `t05903l04` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `FYPHHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (1000, 2022, 2023-05-27 08:05:54, 0, admin, 2023-05-27 08:05:54))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-27 08:05:54', NULL),
(177, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry \'1000-2022\' for key \'FYPHDCalendarId\' (SQL: insert into `t05903l04` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `FYPHHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (1000, 2022, 2023-05-27 08:06:05, 0, admin, 2023-05-27 08:06:05))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-27 08:06:05', NULL),
(178, '{\"message\":\"Attempt to read property \\\"FYPMHMonth\\\" on null\",\"line\":86,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\app\\\\Http\\\\Controllers\\\\Config\\\\FiscalYear\\\\FiscalYearController.php\"}', '2023-05-27 08:18:44', NULL),
(179, '{\"message\":\"Attempt to read property \\\"FYPMHMonth\\\" on null\",\"line\":86,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\app\\\\Http\\\\Controllers\\\\Config\\\\FiscalYear\\\\FiscalYearController.php\"}', '2023-05-27 08:46:33', NULL),
(180, '{\"message\":\"Undefined array key 1\",\"line\":1029,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Concerns\\\\ValidatesAttributes.php\"}', '2023-05-29 07:44:13', NULL),
(181, '{\"message\":\"Undefined array key 1\",\"line\":1029,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Concerns\\\\ValidatesAttributes.php\"}', '2023-05-29 07:51:10', NULL),
(182, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateAfterOrEquals does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:28:08', NULL),
(183, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateAfterOrEquals does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:28:37', NULL),
(184, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date|after does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:36:20', NULL),
(185, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date|after does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:39:12', NULL),
(186, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateBefor does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:41:35', NULL),
(187, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateAfterOrEquals does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:43:09', NULL),
(188, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date|afterOrEqual does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:57:51', NULL),
(189, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date|beforeOrEqual does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:58:50', NULL),
(190, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date|beforeOrEqual does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:59:26', NULL),
(191, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date|beforeOrEqual does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 11:59:39', NULL),
(192, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date| does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 12:08:04', NULL),
(193, '{\"message\":\"Method Illuminate\\\\Validation\\\\Validator::validateRequired|date| does not exist.\",\"line\":1550,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Validation\\\\Validator.php\"}', '2023-05-29 12:08:22', NULL),
(194, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1062 Duplicate entry \'1000-2023-2023-05-01 00:00:00\' for key \'FYPHDCalendarId\' (SQL: insert into `t05903l0411` (`idH`, `FYPHDCalendarId`, `FYPHDFiscalYearId`, `FYPHDHolidayType`, `FYPHDHolidayDate`, `FYPHDDesc1`) values (6, 1000, 2023, PH, 2023-05-01, tt))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-30 09:57:04', NULL),
(195, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'date\' in \'where clause\' (SQL: select count(*) as aggregate from `t05903l0411` where `date` = 2023-05-01 and `FYPHDCalendarId` = 1000 and `FYPHDFiscalYearId` = 2023 and `FYPHDHolidayDate` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-30 10:05:04', NULL),
(196, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'date\' in \'where clause\' (SQL: select count(*) as aggregate from `t05903l0411` where `date` = 2023-05-08 and `FYPHDCalendarId` = 1000 and `FYPHDFiscalYearId` = 2023 and `FYPHDHolidayDate` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-05-30 10:06:49', NULL),
(197, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'FYPHHCalendarId\' in \'field list\' (SQL: insert into `t11130l01` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `LALBHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (?, ?, 2023-06-13 00:32:04, 0, admin, 2023-06-13 00:32:04))\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 12:32:04', NULL),
(198, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'FYPHHCalendarId\' in \'field list\' (SQL: insert into `t11130l01` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `LALBHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (?, ?, 2023-06-13 00:32:17, 0, admin, 2023-06-13 00:32:17))\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 12:32:17', NULL),
(199, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'FYPHHCalendarId\' in \'field list\' (SQL: insert into `t11130l01` (`FYPHHCalendarId`, `FYPHHFiscalYearId`, `FYPHHLastCreated`, `LALBHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (?, ?, 2023-06-13 00:33:02, 0, admin, 2023-06-13 00:33:02))\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 12:33:02', NULL),
(200, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'FYPHHLastCreated\' in \'field list\' (SQL: insert into `t11130l01` (`LALBHLoanId`, `LALBHCompanyId`, `LALBHLocationId`, `LALBHEmployeeId`, `LALBHDeductionId`, `LALBHLoanAmount`, `LALBHInterestAmount`, `LALBHRecoveryAmount`, `LALBHNoOfEMI`, `LALBHEMIAmount`, `LALBHTotalDeduction`, `LALBHStartDateEMI`, `LALBHEndDateEMI`, `LALBHPaidEMI`, `LALBHBalanceEMI`, `LALBHPaidAmount`, `LALBHBalanceAmount`, `LALBHLoanPaidFully`, `FYPHHLastCreated`, `LALBHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (?, 1000, ?, 1200, 1000, 500, 0.00, 0.00, 02, 250, ?, 10-05-2023, 09-07-2023, 0, 0, 0.00, 0.00, ?, 2023-06-13 15:30:48, 0, admin, 2023-06-13 15:30:48))\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 03:30:48', NULL),
(201, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'FYPHHLastCreated\' in \'field list\' (SQL: insert into `t11130l01` (`LALBHLoanId`, `LALBHCompanyId`, `LALBHLocationId`, `LALBHEmployeeId`, `LALBHDeductionId`, `LALBHLoanAmount`, `LALBHInterestAmount`, `LALBHRecoveryAmount`, `LALBHNoOfEMI`, `LALBHEMIAmount`, `LALBHTotalDeduction`, `LALBHStartDateEMI`, `LALBHEndDateEMI`, `LALBHPaidEMI`, `LALBHBalanceEMI`, `LALBHPaidAmount`, `LALBHBalanceAmount`, `LALBHLoanPaidFully`, `FYPHHLastCreated`, `LALBHMarkForDeletion`, `FYPHHUser`, `FYPHHLastUpdated`) values (?, 1000, ?, 1200, 1000, 500, 0.00, 0.00, 02, 250, ?, 10-05-2023, 09-07-2023, 0, 0, 0.00, 0.00, ?, 2023-06-13 15:30:58, 0, admin, 2023-06-13 15:30:58))\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 03:30:58', NULL),
(202, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1048 Column \'LALBHLoanId\' cannot be null (SQL: insert into `t11130l01` (`LALBHLoanId`, `LALBHCompanyId`, `LALBHLocationId`, `LALBHEmployeeId`, `LALBHDeductionId`, `LALBHLoanAmount`, `LALBHInterestAmount`, `LALBHRecoveryAmount`, `LALBHNoOfEMI`, `LALBHEMIAmount`, `LALBHTotalDeduction`, `LALBHStartDateEMI`, `LALBHEndDateEMI`, `LALBHPaidEMI`, `LALBHBalanceEMI`, `LALBHPaidAmount`, `LALBHBalanceAmount`, `LALBHLoanPaidFully`, `LALBHLastCreated`, `LALBHMarkForDeletion`, `LALBHUser`, `LALBHLastUpdated`) values (?, 1000, ?, 1200, 1000, 2500, 0.00, 0.00, 02, 1250, ?, 01-06-2023, 31-07-2023, 0, 0, 0.00, 0.00, ?, 2023-06-13 15:34:25, 0, admin, 2023-06-13 15:34:25))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 03:34:25', NULL),
(203, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1048 Column \'LALBHLocationId\' cannot be null (SQL: insert into `t11130l01` (`LALBHLoanId`, `LALBHCompanyId`, `LALBHLocationId`, `LALBHEmployeeId`, `LALBHDeductionId`, `LALBHLoanAmount`, `LALBHInterestAmount`, `LALBHRecoveryAmount`, `LALBHNoOfEMI`, `LALBHEMIAmount`, `LALBHTotalDeduction`, `LALBHStartDateEMI`, `LALBHEndDateEMI`, `LALBHPaidEMI`, `LALBHBalanceEMI`, `LALBHPaidAmount`, `LALBHBalanceAmount`, `LALBHLoanPaidFully`, `LALBHLastCreated`, `LALBHMarkForDeletion`, `LALBHUser`, `LALBHLastUpdated`) values (1686651039, 1000, ?, 1000, 1000, 2500, 0.00, 0.00, 02, 1250, ?, 01-06-2023, 31-07-2023, 0, 0, 0.00, 0.00, ?, 2023-06-13 15:40:39, 0, admin, 2023-06-13 15:40:39))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 03:40:39', NULL),
(204, '{\"message\":\"SQLSTATE[22007]: Invalid datetime format: 1292 Incorrect date value: \'01-06-2023\' for column `ems`.`t11130l01`.`LALBHStartDateEMI` at row 1 (SQL: insert into `t11130l01` (`LALBHLoanId`, `LALBHCompanyId`, `LALBHLocationId`, `LALBHEmployeeId`, `LALBHDeductionId`, `LALBHLoanAmount`, `LALBHInterestAmount`, `LALBHRecoveryAmount`, `LALBHNoOfEMI`, `LALBHEMIAmount`, `LALBHTotalDeduction`, `LALBHStartDateEMI`, `LALBHEndDateEMI`, `LALBHPaidEMI`, `LALBHBalanceEMI`, `LALBHPaidAmount`, `LALBHBalanceAmount`, `LALBHLoanPaidFully`, `LALBHLastCreated`, `LALBHMarkForDeletion`, `LALBHUser`, `LALBHLastUpdated`) values (1686651387, 1000, 10, 1000, 1000, 2500, 0.00, 0.00, 02, 1250, ?, 01-06-2023, 31-07-2023, 0, 0, 0.00, 0.00, ?, 2023-06-13 15:46:27, 0, admin, 2023-06-13 15:46:27))\",\"line\":760,\"code\":\"22007\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 03:46:27', NULL),
(205, '{\"message\":\"SQLSTATE[22007]: Invalid datetime format: 1292 Incorrect date value: \'01-06-2023\' for column `ems`.`t11130l01`.`LALBHStartDateEMI` at row 1 (SQL: insert into `t11130l01` (`LALBHLoanId`, `LALBHCompanyId`, `LALBHLocationId`, `LALBHEmployeeId`, `LALBHDeductionId`, `LALBHLoanAmount`, `LALBHInterestAmount`, `LALBHRecoveryAmount`, `LALBHNoOfEMI`, `LALBHEMIAmount`, `LALBHTotalDeduction`, `LALBHStartDateEMI`, `LALBHEndDateEMI`, `LALBHPaidEMI`, `LALBHBalanceEMI`, `LALBHPaidAmount`, `LALBHBalanceAmount`, `LALBHLoanPaidFully`, `LALBHLastCreated`, `LALBHMarkForDeletion`, `LALBHUser`, `LALBHLastUpdated`) values (1686651488, 1000, 10, 1000, 1000, 2500, 0.00, 0.00, 02, 1250, ?, 01-06-2023, 31-07-2023, 0, 0, 0.00, 0.00, ?, 2023-06-13 15:48:08, 0, admin, 2023-06-13 15:48:08))\",\"line\":760,\"code\":\"22007\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 03:48:08', NULL),
(206, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-06-01 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 04:29:57', NULL),
(207, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-06-01 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 04:30:18', NULL),
(208, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-06-01 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-13 04:30:20', NULL),
(209, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-06-28 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-15 08:45:04', NULL),
(210, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-06-28 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-15 08:45:17', NULL),
(211, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-07-07 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-15 08:47:45', NULL),
(212, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-07-07 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-15 08:47:55', NULL),
(213, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'start_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `start_date` = 2023-06 and `LALBDLoanId` is null and `LALBDStartDateEMI` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-15 08:51:04', NULL),
(214, '{\"message\":\"SQLSTATE[42S22]: Column not found: 1054 Unknown column \'emi_date\' in \'where clause\' (SQL: select count(*) as aggregate from `t11130l0111` where `emi_date` = 2023-02 and `LALBDLoanId` is null and `LALBDEMIDate` != =)\",\"line\":760,\"code\":\"42S22\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-06-21 05:35:21', NULL),
(215, '{\"message\":\"Undefined array key \\\"emi_amt\\\"\",\"line\":108,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\app\\\\Http\\\\Controllers\\\\Payroll\\\\Process\\\\AdHocIncomeController.php\"}', '2023-07-04 09:18:33', NULL),
(216, '{\"message\":\"Undefined variable $HeaderTable\",\"line\":121,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\app\\\\Http\\\\Controllers\\\\Payroll\\\\Process\\\\AdHocIncomeController.php\"}', '2023-07-04 09:20:28', NULL),
(217, '{\"message\":\"SQLSTATE[HY000]: General error: 1364 Field \'PGAIDCompanyId\' doesn\'t have a default value (SQL: insert into `T11125L0411` (`PGAIDFiscalYear`, `PGAIDPeriodId`, `PGAIDLocationId`, `PGAIDEmployeeId`, `PGAIDIncDedId`, `PGAIDGrossAmount`, `PGAIDGrossPayment`, `PGAIDMarkForDeletion`, `PGAIDUser`, `PGAIDLastCreated`, `PGAIDLastUpdated`) values (2023, 3, 20, 1100, 1100, 250, 2520, 0, admin, 2023-07-04 09:30:03, 2023-07-04 09:30:03))\",\"line\":760,\"code\":\"HY000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-07-04 09:30:03', NULL),
(218, '{\"message\":\"SQLSTATE[HY000]: General error: 1364 Field \'PGAIDEmployeeId\' doesn\'t have a default value (SQL: insert into `T11125L0411` (`PGAIDCompanyId`, `PGAIDFiscalYear`, `PGAIDPeriodId`, `PGAIDLocationId`, `PGAIDIncDedId`, `PGAIDGrossAmount`, `PGAIDGrossPayment`, `PGAIDMarkForDeletion`, `PGAIDUser`, `PGAIDLastCreated`, `PGAIDLastUpdated`) values (1000, 2023, 3, 20, 1000, 1220, 2550, 0, admin, 2023-07-04 09:34:51, 2023-07-04 09:34:51))\",\"line\":760,\"code\":\"HY000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-07-04 09:34:51', NULL),
(219, '{\"message\":\"SQLSTATE[23000]: Integrity constraint violation: 1048 Column \'PGAIDEmployeeId\' cannot be null (SQL: insert into `T11125L0411` (`PGAIDCompanyId`, `PGAIDFiscalYear`, `PGAIDPeriodId`, `PGAIDLocationId`, `PGAIDEmployeeId`, `PGAIDIncDedId`, `PGAIDGrossAmount`, `PGAIDGrossPayment`, `PGAIDMarkForDeletion`, `PGAIDUser`, `PGAIDLastCreated`, `PGAIDLastUpdated`) values (1000, 2023, 3, 10, ?, 1000, 250, 250, 0, admin, 2023-07-04 09:36:19, 2023-07-04 09:36:19))\",\"line\":760,\"code\":\"23000\",\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Database\\\\Connection.php\"}', '2023-07-04 09:36:19', NULL),
(220, '{\"message\":\"Property [PMITHDesc1] does not exist on this collection instance.\",\"line\":940,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Collections\\\\Traits\\\\EnumeratesValues.php\"}', '2023-07-04 09:44:56', NULL),
(221, '{\"message\":\"Property [PMITHDesc1] does not exist on this collection instance.\",\"line\":940,\"code\":0,\"file\":\"E:\\\\3SIS_Pro\\\\3SISPro_Test\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Collections\\\\Traits\\\\EnumeratesValues.php\"}', '2023-07-04 09:45:14', NULL);
...
--
-- Indexes for table `t05903l0312`
--
ALTER TABLE `t05903l0312`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `t11125l0311`
--
ALTER TABLE `t11125l0311`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `t11125l0411`
--
ALTER TABLE `t11125l0411`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `t11130l01`
--
ALTER TABLE `t11130l01`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `t11130l0111`
--
ALTER TABLE `t11130l0111`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `t05903l0312`
--
ALTER TABLE `t05903l0312`
...
--
-- AUTO_INCREMENT for table `t11125l0311`
--
ALTER TABLE `t11125l0311`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `t11125l0411`
--
ALTER TABLE `t11125l0411`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `t11130l01`
--
ALTER TABLE `t11130l01`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `t11130l0111`
--
ALTER TABLE `t11130l0111`
