            ...
            togglethemeEl.addEventListener('click', function() {
                ...
                if (parseObj.settings.layout.darkMode) {
                    ...
                    if (!getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../../assets/img/LOGOForPayroll.png')
                        } else {
                    ...
                    if (getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('../../assets/img/LOGOForPayroll.png')
                        } else {
                            document.querySelector('.navbar-logo').setAttribute(getUpdatedParseObject.settings.layout.logo.darkLogo)
                        }
