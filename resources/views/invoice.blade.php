    <!-- <img src="assets/img_pdf/logo.jpg"> -->
    <!-- <p style="text-align: center;border:1px solid #000;">Payslip</p>

     <table align="left">
      <tbody>
        <tr>
            <td>Period : Sep-2020</td>
        </tr>
      </tbody>
    </table>
    <table align="right">
...
<table width="100%" style="border:none;">
    <tr>
        <td width="50%" align="left" style="border:none;"><span style="font-size: 15px; text-align:left;">
                <strong>Name :</strong> Sindhu Chandran A</span>
        </td>
        <td width="20%" align="left" style="border:none;"><span
                style="font-size: 15px; text-align:left;"><strong>Employee Id: </strong> srgrth</span>
        </td>
    </tr>
     <tr>
        <td width="50%" align="left" style="border:none;"><span style="font-size: 15px; text-align:left;">
                <strong>Join Date: </strong> 01/06/2011</span>
        </td>
        <td width="20%" align="left" style="border:none;"><span
                style="font-size: 15px; text-align:left;"><strong>Bank Name :  </strong> Axis Bank</span>
        </td>
    </tr>
     <tr>
        <td width="50%" align="left" style="border:none;"><span style="font-size: 15px; text-align:left;">
                <strong>Department: </strong> KMC1997DBT01M</span>
        </td>
        <td width="20%" align="left" style="border:none;"><span
                style="font-size: 15px; text-align:left;"><strong>A/C No.
:  </strong> 920010007435113</span>
        </td>
    </tr>

     <tr>
        <td width="50%" align="left" style="border:none;"><span style="font-size: 15px; text-align:left;">
                <strong>Designation:  </strong> Accountant</span>
        </td>
        <td width="20%" align="left" style="border:none;"><span
                style="font-size: 15px; text-align:left;"><strong>IFS Code: </strong> UTIB0003736</span>
        </td>
    </tr>
    <tr>
        <td width="50%" align="left" style="border:none;"><span style="font-size: 15px; text-align:left;">
        ...
        <td width="20%" align="left" style="border:none;"><span
                style="font-size: 15px; text-align:left;"><strong>Employment Type :  </strong> Permanant</span>
        </td>
    </tr>
</table>
...
<table style="width:100%;border: 1px solid black;
  ...
  border-collapse: collapse;text-align: left;" width="20%">Income Entity</th>
    <th style="border: 1px solid black;
  border-collapse: collapse;text-align: center;">Taxabl</th> 
    <th style="border: 1px solid black;
  ...
  <th style="border: 1px solid black;
  border-collapse: collapse;text-align: center;">Tax Exempt</th>
   <th style="border: 1px solid black;
  border-collapse: collapse;text-align: right;" width="12%">Fixed</th>
   <th style="border: 1px solid black;
  border-collapse: collapse;text-align: right;" width="12%">Net Amt.</th>
  ...
  border-collapse: collapse;text-align: left;">Basic</td>

   <td style="border: 1px solid black;
  border-collapse: collapse;text-align: center;">Y</td>

   <td style="border: 1px solid black;
  border-collapse: collapse;text-align: right;">14,100.00</td>
