...
<div class="mt-1" style="padding: 10px;background-color: #101427;border-radius: 6px;position: sticky;top: 114px;z-index: 1;">
   <div class="row justify-content-center">
      ...
      <div class="col-auto">
         ...
         <a href="{{ url('manage-state') }}" class="btn btn-info">List</a>
         <a href="javascript:void(0)" id="save" class="btn btn-success">Add</a>
         @endif
   ...
   <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
      <div class="statbox widget box box-shadow">
         ...
         <div class="widget-content widget-content-area">
            <form class="row g-3" id='singleLevelDataEntryForm' autocomplete="off" method="post"
        ...
        value="{{ old('GMSMHStateId', $edit_data['GMSMHStateId'] ?? '') }}" 
               ...
               <div class="col-6 mb-4">
                  ...
                  <select id='GMSMHCountryId' name='GMSMHCountryId' class="form-select" style="width: 100%;border: 1px solid #68a6ec;">
                     ...
                     @if(!empty($edit_data['GMSMHCountryId']) == $country->GMCMHCountryId)
...
<script type="text/javascript">
   ...
   $('#save').click(function(){
    $('#btn_error').show();
    $('#GMSMHStateId,#GMSMHDesc1,#GMSMHDesc2').removeClass('border border-danger');
...
// }
       ...
       return false;
        ...
        // console.log($('#singleLevelDataEntryForm').attr('action'));
        // return false;
        $.ajax({
                url: $('#singleLevelDataEntryForm').attr('action'),
                method: $('#singleLevelDataEntryForm').attr('method'),
                ...
                success: function (response) {
                    ...
                    if(response.status == 'success'){
                        if (action == 'insert') {
                            ...
                            $('.error_msg').html($('#GMSMHStateId').val(),$('#GMSMHDesc1').val(), 'Added');
