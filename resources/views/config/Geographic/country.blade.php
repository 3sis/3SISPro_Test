    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
        <div class=" br-6" style="padding-top: 5px;">
            <div style='float:right; padding-right:30px'>
                ...
                <button type='button' name='add' id='add_Data' class='btnAddRec3SIS' title="Add Country">
                                    ...
                                    <div id="defaultAccordionOne" class="collapse show" aria-labelledby="..."
                                        ...
                                        <div class="card-body">
                                            <form id='singleLevelDataEntryForm' autocomplete="off" method="post"
                                                action="{{ url('/country/save') }}">
                                                @csrf
                                                <input type="hidden" name="id" id="id">
                                                <div class="row mb-4">
                                                    <div class="col-md-4">
                                                        <div class='form-group'>
                                                            <label class="form-label">Country Id <b
                                                                    class="text-danger">*</b></label>
                                                            <input type="text" name='GMCMHCountryId'
                                                                id='GMCMHCountryId' class='form-control few-options'
                                                                maxlength="10" placeholder="Enter Country Name"
                                                                style='opacity:1'>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class='form-group'>
                                                            <label class="form-label">Description 1 <b
                                                                class="text-danger">*</b></label>
                                                            <input type="text" name='GMCMHDesc1' id='GMCMHDesc1' class='form-control few-options' placeholder="Enter Country Description 1"
                                                ...
                                                <div class="row mt-0">
                                                    <div class="col-md-12">
                                                        <div class='form-group'>
                                                            ...
                                                            <textarea name='GMCMHDesc2' id='GMCMHDesc2' class='form-control few-options' placeholder="Enter Country Description 2"
