        ...
        <form id='AddForm' method="post" autocomplete="off">
            <div class="row justify-content-center">
                ...
                <div class="col-auto">
                    ...
                    <a class="btn btn-success btn-icon" href="{{ url('country/add') }}" title="Create">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <a class="btn btn-light btn-icon" href="{{ url('country_report/excel') }}" target="_blank" title="Excel">
                    ...
                    <a class="btn btn-light btn-icon" href="{{ url('country_report/pdf') }}" target="_blank" title="Pdf">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
                            <path fill="#e53935"
...
@if ($action == 'add' || $action == 'edit')
    <nav id="navbar-example2" class="navbar sticky-top bg-dark" style="top: 110px;">
        ...
        <div class="col-auto me-1">
            ...
            <a href="{{ url('country') }}" class="btn btn-info" title="Back"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg></a>
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row g-3">
                            ...
                            @endif
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Country Id<b class="text-danger">*</b></label>
                                <input type="text" name='GMCMHCountryId' id='GMCMHCountryId'
                                    ...
                                    value="{{ old('GMCMHCountryId', $edit_data['GMCMHCountryId'] ?? '') }}">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name='GMCMHDesc1' id='GMCMHDesc1'
                                    ...
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMCMHDesc1', $edit_data['GMCMHDesc1'] ?? '') }}">
                            </div>
                            <div class="col-12">
                                ...
                                <textarea name='GMCMHDesc2' id='GMCMHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Country Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('GMCMHDesc2', $edit_data['GMCMHDesc2'] ?? '') }}</textarea>
                            </div>
                        </div>
                        </form>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name='GMCMHUser' id='GMCMHUser'
                                    ...
                                    value="{{ old('GMCMHUser', $edit_data['GMCMHUser'] ?? '') }}" readonly>
                                     @else
                                      <input type="text" name='GMCMHUser' id='GMCMHUser'
                                    class='form-control input_border'
                            ...
                            <div class="col-md-4">
                                <label for="Created" class="form-label">Created On</label>
                                 @if(!empty($edit_data['id']))
                                   <input type="text" name='GMCMHLastCreated' id='GMCMHLastCreated'
                                    class='form-control input_border'
                                    value="{{ date('d-m-Y',strtotime($edit_data['GMCMHLastCreated']))}}" readonly>
                                 @else
                                  <input id="GMCMHLastCreated" name='GMCMHLastCreated' class="form-control flatpickr flatpickr-input active input_border" type="text" placeholder="Select Date.." readonly="readonly">
                                @endif
                            </div>
                            <div class="col-md-4">
                                <label for="Updated" class="form-label">Updated On</label>
                                 @if(!empty($edit_data['id']))
                                  <input id="GMCMHLastUpdated" name='GMCMHLastUpdated' class="form-control flatpickr flatpickr-input active input_border" type="text" placeholder="Select Date.." readonly="readonly" value="{{ date('d-m-Y',strtotime($edit_data['GMCMHLastUpdated']))}}">
                                 @else
                                  <input id="GMCMHLastUpdated" name='GMCMHLastUpdated' class="form-control flatpickr flatpickr-input active input_border" type="text" placeholder="Select Date.." readonly="readonly">
                                @endif
                            </div>
                        </div>
...
{{-- <!-- <script src={{ asset('assets/common/js/CountryMasterAjax.js') }}></script> --> --}}
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        if (action == 'insert') {
                            $finalMessage3SIS = fnSingleLevelFinalSave('country', $('#GMCMHCountryId')
                                .val(), $('#GMCMHDesc1').val(), 'Added');
                    ...
                    if (response.status == 'error') {
                        $('.error_msg').append('<p>Country Master not save</p>');
                    }
                }
            })
        }
    ...
    $('#Undelete_Data').click(function() {
        ...
        $('.modal-title').text('Restore Country');
...
console.log($('#id').val());
if($('#id').val() != undefined){
    $('#GMCMHLastCreated,#GMCMHLastUpdated').flatpickr({
    dateFormat: "d-m-Y"
});
}else{
    $('#GMCMHLastCreated,#GMCMHLastUpdated').flatpickr({
