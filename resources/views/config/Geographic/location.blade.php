                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row g-3">
                            ...
                            @endif
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Location Id<span class="text-danger"> *</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="inputPassword4" class="form-label">Description 1<span class="text-danger"> *</span></label>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                {{-- <input type="date" name='GMLMHLastCreated' id='GMLMHLastCreated'
                                    class='form-control '
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMLMHLastCreated', if($action == 'edit',date('Y-m-d',strtotime($edit_data['GMLMHLastCreated'])) , 'Y-m-d') }}" readonly>
                                    value="{{ old('GMLMHLastCreated', $edit_data->GMLMHLastCreated->format('d/m/Y') ?? '') }}" readonly> --}}
                            ...
                            {{-- <div class="col-md-4">
                                ...
                                <input type="date" name='GMLMHLastUpdated' id='GMLMHLastUpdated'
                                    class='form-control '
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('GMLMHLastUpdated', if($action == 'edit',date('Y-m-d',strtotime($edit_data['GMLMHLastUpdated'])) ,'Y-m-d') }}" readonly>
                            </div> --}}
                        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        if (action == 'insert') {
                            $finalMessage3SIS = fnSingleLevelFinalSave('location', $('#GMLMHLocationId')
