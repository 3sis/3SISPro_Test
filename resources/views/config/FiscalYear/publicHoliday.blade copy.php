        ...
        <div class="col-auto me-auto mt-2">
            <form id='AddForm' method="post" autocomplete="off">
                <ul class="nav nav-pills mb-2 ms-1">
                    ...
                    <li class="nav-item" id="nav-holiday-tab"><a class="nav-link" href="#holiday">Public Holiday</a></li>
...
@if ($action == 'add' || $action == 'edit')
    ...
    <main data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%"
        ...
        @endif
        <div class="modal fade" id="DetailAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Public Holiday Detail</h5>
                    <button type="button" data-bs-dismiss="modal" aria-label="Close">
                        X
                    </button>
                </div>
                <form id='AddDetailForm' method="post" autocomplete="off">

                    <div class="modal-body">
                        <div class="widget-content widget-content-area-detail3SIS animated-underline-content">
                            <div class="container-fluid">
                                <div class='form-group mb-0'>
                                    <input type="hidden" name='id' id='id' class='form-control-detail3SIS'>
                                    <input type="hidden" name='idH' id='idH' class='form-control-detail3SIS'>
                                    {{-- @csrf --}}

                                    {{-- <input type="hidden" name="_token" id='tokenId' value="{{ csrf_token() }}" /> --}}
                                </div>
                                <!-- Fiscal Year -->
                                <div class="row mt-0">
                                    <div class="col-md-4">
