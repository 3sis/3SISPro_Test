        ...
        <form id='AddForm' method="post" autocomplete="off">
            <div class="row justify-content-center">
                ...
                <div class="col-auto">
                    ...
                    <a class="btn btn-success btn-icon" href="{{ url('incomeType/add') }}" title="Create">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <a class="btn btn-light btn-icon" href="{{ url('incomeType_report/excel') }}" target="_blank"
                        title="Excel">
                    ...
                    <a class="btn btn-light btn-icon" href="{{ url('incomeType_report/pdf') }}" target="_blank"
                        title="Pdf">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
                            <path fill="#e53935"
...
@if ($action == 'add' || $action == 'edit')
    <nav id="navbar-example2" class="navbar sticky-top bg-dark" style="top: 110px;">
        ...
        <div class="col-auto me-1">
            ...
            <a href="{{ url('incomeType') }}" class="btn btn-info" title="Back"><svg
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row g-3">
                            ...
                            @endif
                            <div class="col-md-3">
                                <label for="inputEmail4" class="form-label">Income Id<b
                                        class="text-danger">*</b></label>
                                <input type="text" name='PMITHIncomeId' id='PMITHIncomeId'
                                    class='form-control threshold' maxlength="20" placeholder="Enter Income Id"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('PMITHIncomeId', $edit_data['PMITHIncomeId'] ?? '') }}">
                            </div>
                            <div class="col-md-4">
                                <label for="inputPassword4" class="form-label">Description 1<b
                                        class="text-danger">*</b></label>
                                <input type="text" name='PMITHDesc1' id='PMITHDesc1'
                                    class='form-control threshold' maxlength="20"
                                    placeholder="Enter Income Description 1"
                                    style='border-color: rgb(102, 175, 233); outline: 0px'
                                    value="{{ old('PMITHDesc1', $edit_data['PMITHDesc1'] ?? '') }}">
                            </div>
                            <div class="col-md-5">
                                <label for="inputAddress" class="form-label">Description 2</label>
                                <textarea name='PMITHDesc2' id='PMITHDesc2' class='form-control textarea' maxlength="200"
                                    placeholder="Enter Income Description 2" style='border-color: rgb(102, 175, 233); outline: 0px'>{{ old('PMITHDesc2', $edit_data['PMITHDesc2'] ?? '') }}</textarea>
                            </div>
                            <div class="col-md-2">
                                {{-- <div class="row mt-0"> --}}
                                <div class="n-chk col-md-12">
                                    <div class="form-check form-check-primary form-check-inline">
                                        @if (!empty($edit_data['PMITHIsTaxable']))
                                            <input class="form-check-input" type="checkbox" name='PMITHIsTaxable'
                                                id='PMITHIsTaxable' value="{{ $edit_data['PMITHIsTaxable'] }}"
                                                checked>
                                        @else
                                            <input class="form-check-input" type="checkbox" name='PMITHIsTaxable'
                                                id='PMITHIsTaxable'
                                                value="{{ old('PMITHIsTaxable', $edit_data['PMITHIsTaxable'] ?? '') }}">
                                        @endif
                                ...
                                <div class="col-md-2">
                                    <label for="inputSelect" class="form-label">Payment Cycle<b
                                            class="text-danger">*</b></label>
                                    <select id='PMITHIncomeCycle' name='PMITHIncomeCycle' class="form-select"
                                        ...
                                        @foreach ($payCycle as $Cycle)
                                            ...
                                            @else
                                                <option value='{{ $Cycle->PMPCHCycleId }}'>
                                                    {{ $Cycle->PMPCHDesc1 }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id='PMITHRoundingStrategy' name='PMITHRoundingStrategy'
                                        class="form-select" style="width: 100%;border: 1px solid #68a6ec;">
                                        <option value=''>--Select Rounding--</option>
                                        @foreach ($round_list as $Rounding)
                                            @if (!empty($edit_data['PMITHRoundingStrategy']) && $edit_data['PMITHRoundingStrategy'] == $Rounding->RSRSHRoundingId)
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select id='PMITHRuleId' name='PMITHRuleId' class="form-select"
                                        style="width: 100%;border: 1px solid #68a6ec;">
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        @if (!empty($edit_data['id']))
                                            <input type="text" name='PMITHUser' id='PMITHUser'
                                                ...
                                                value="{{ old('PMITHUser', $edit_data['PMITHUser'] ?? '') }}"
                                                readonly>
                                        @else
                                            <input type="text" name='PMITHUser' id='PMITHUser'
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @if (!empty($edit_data['id']))
                                            <input type="text" name='PMITHLastCreated' id='PMITHLastCreated'
                                                class='form-control input_border'
                                                value="{{ date('d-m-Y', strtotime($edit_data['PMITHLastCreated'])) }}"
                                                readonly>
                                        @else
                                            <input id="PMITHLastCreated" name='PMITHLastCreated'
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @if (!empty($edit_data['id']))
                                            <input id="PMITHLastUpdated" name='PMITHLastUpdated'
                                                class="form-control flatpickr flatpickr-input active input_border"
                                                type="text" placeholder="Select Date.." readonly="readonly"
                                                value="{{ date('d-m-Y', strtotime($edit_data['PMITHLastUpdated'])) }}">
                                        @else
                                            <input id="PMITHLastUpdated" name='PMITHLastUpdated'
                                                class="form-control flatpickr flatpickr-input active input_border"
                                                type="text" placeholder="Select Date.." readonly="readonly">
...
<script type="text/javascript">
    ...
    $("#AddForm").submit(function(e) {
        e.preventDefault();
        $('#PMITHIncomeId,#PMITHDesc1,#select2-PMITHIncomeCycle-container,#select2-PMITHRoundingStrategy-container,#select2-PMITHRuleId-container').removeClass(
        ...
        if ($('#PMITHRoundingStrategy').val() == '') {
            $('#select2-PMITHRoundingStrategy-container').addClass('border border-danger');
        }
        if ($('#PMITHRuleId').val() == '') {
            $('#select2-PMITHRuleId-container').addClass('border border-danger');
        }
        $('.msg_error').html('');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        if (action == 'insert') {
                            $finalMessage3SIS = fnSingleLevelFinalSave('Income Type', $(
                                    '#PMITHIncomeId')
                                .val(), $('#PMITHDesc1').val(), 'Added');
                        ...
                        if (action == 'update') {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Income Id updated successfully',
                                allowOutsideClick: false,
                                timer: 5000,
                            })
                            window.location = "{{ url('incomeType') }}";

                        }
                    }
                    if (response.status == 'error') {
                        $('.error_msg').append('<p>Income type Master not save</p>');
                    }
                }
            })
    });
    ...
    $('#Undelete_Data').click(function() {
        ...
        $('.modal-title').text('Restore Income Type');
    ...
    $(document).on('click', '.delete', function() {
        ...
        $deleteMessage3SIS = fnConfirmationMsg('Delete', 'Income Type', id, desc);
        $successMessage3SIS = fnSuccessMsg('Deleted', 'Income Type', id, desc);
    ...
    $(document).on('click', '.restore', function() {
        ...
        var id = $(this).attr('id');
        var desc = $(this).closest("tr").find("td:eq(1)").text();
        $restoreMessage3SIS = fnConfirmationMsg('Restore', 'Income Type', id, desc);
        Swal.fire({
    ...
    console.log($('#id').val());
    if ($('#id').val() != undefined) {
        $('#PMITHLastCreated,#PMITHLastUpdated').flatpickr({
            dateFormat: "d-m-Y"
        });
    } else {
        $('#PMITHLastCreated,#PMITHLastUpdated').flatpickr({
