...
<!-- sweetalert2 -->
 <!-- BEGIN THEME GLOBAL STYLES -->
    ...
    <link href="https://designreset.com/cork/html/src/plugins/css/light/sweetalerts2/custom-sweetalert.css" rel="stylesheet" type="text/css" />
    <link href="https://designreset.com/cork/html/src/plugins/css/dark/sweetalerts2/custom-sweetalert.css" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
<!-- sweetalert2 -->
<!-- BEGIN PAGE LEVEL CUSTOM STYLES -->
<link rel="stylesheet" type="text/css" href="https://designreset.com/cork/html/src/plugins/src/table/datatable/datatables.css">
<link rel="stylesheet" type="text/css" href="https://designreset.com/cork/html/src/plugins/css/light/table/datatable/dt-global_style.css">
<link rel="stylesheet" type="text/css" href="https://designreset.com/cork/html/src/plugins/css/light/table/datatable/custom_dt_custom.css">
<link rel="stylesheet" type="text/css" href="https://designreset.com/cork/html/src/plugins/css/dark/table/datatable/dt-global_style.css">
<link rel="stylesheet" type="text/css" href="https://designreset.com/cork/html/src/plugins/css/dark/table/datatable/custom_dt_custom.css">
   ...
   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
      <div class=" br-6" style="padding-top: 5px;">
         ...
         <div class="table-responsive">
            <table id="landingPageBrowser3SIS" class="table dt-table-hover dataTable no-footer purple_Browser2D_3SIS">
               <thead>
                  <tr>
         ...
         <!-- start undeletemodal -->
       <div id="UndoModal" class="modal fade" data-backdrop="static"
            data-keyboard="false" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered 3SISPro-modal-dialog" role="document" style="max-width:1000px!important;">
                                    ...
                                    <div class="row mb-4">
                                       <div class="col-md-4">
                                          <div class='form-group'>
                                             <label class="form-label">State Id <b class="text-danger">*</b></label>
                                       ...
                                       <div class="col-md-4">
                                          <div class='form-group'>
                                             ...
                                             <textarea name='GMSMHDesc1' id='GMSMHDesc1' class='form-control few-options' placeholder="Enter State Description 1" style='border-color: rgb(102, 175, 233); outline: 0px'></textarea>
                                             <span class="text-danger"></span>
                                          </div>
                                       </div>
                                       <div class="col-md-4">
                                    ...
                                    <div class="row mt-0">
                                         ...
                                         <div class="col-md-4">
                                           <div class='form-group'>
                                            ...
                                            <select id='GMSMHCountryId' name='GMSMHCountryId' class="form-select"  style='width: 100%;'>
